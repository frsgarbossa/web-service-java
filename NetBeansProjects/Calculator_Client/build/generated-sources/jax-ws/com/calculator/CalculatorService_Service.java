 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://calculator.com/", wsdlLocation = "http://localhost:8084/Calculator/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://calculator.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/Calculator/CalculatorService?wsdl");
    ...
    public CalculatorService getCalculatorServicePort() {
        return super.getPort(new QName("http://calculator.com/", "CalculatorServicePort"), CalculatorService.class);
    }
    ...
    public CalculatorService getCalculatorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator.com/", "CalculatorServicePort"), CalculatorService.class, features);
    }
