 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://calculator.com/", wsdlLocation = "http://localhost:8084/Calculator/Calculator?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8084/Calculator/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://calculator.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator.com/", "CalculatorPort"), Calculator.class, features);
    }
