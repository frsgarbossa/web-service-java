 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://calcolo.com/", wsdlLocation = "http://localhost:8084/WS_prova/CalcoloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://calcolo.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/WS_prova/CalcoloService?wsdl");
     ...
     * 
     * @return
     *     returns CalcoloService
     */
    @WebEndpoint(name = "CalcoloServicePort")
    public CalcoloService getCalcoloServicePort() {
        return super.getPort(new QName("http://calcolo.com/", "CalcoloServicePort"), CalcoloService.class);
    }
     ...
     */
    @WebEndpoint(name = "CalcoloServicePort")
    public CalcoloService getCalcoloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calcolo.com/", "CalcoloServicePort"), CalcoloService.class, features);
    }
